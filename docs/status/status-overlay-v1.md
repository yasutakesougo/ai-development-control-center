...
**Status: DESIGNED · runtime generator IMPLEMENTED · GitHub/workflow observer IMPLEMENTED · UI IMPLEMENTED (read-only) · runtime wiring MERGED · production pilot HOLD (see `status-overlay-v1-pilot-enablement.md`)**
